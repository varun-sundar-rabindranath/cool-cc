...
# Apps vars
APPS_SOURCE_DIR=${PROJECT_SOURCE_DIR}"/apps"
APPS_BUILD_DIR=${APPS_SOURCE_DIR}"/out/build"
APPS_INSTALL_DIR=${APPS_BUILD_DIR}"/install"
APPS_BIN_DIR=${APPS_INSTALL_DIR}"/bin"

export APPS_SOURCE_DIR=${APPS_SOURCE_DIR}
export APPS_BUILD_DIR=${APPS_BUILD_DIR}
export APPS_INSTALL_DIR=${APPS_INSTALL_DIR}

export PATH=${PATH}:${COMPILER_BIN_PATH}:${PL_BIN_DIR}:${APPS_BIN_DIR}
